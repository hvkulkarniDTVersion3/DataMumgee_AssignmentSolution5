...
public class DataMungerTest {
	...
	public void withWhereEqualAndNotEqualTestCase() {
		...
		HashMap dataSet = query.executeQuery("select season,city,winner,team1,team2,player_of_match from data/ipl.csv where season >= 2013 and season <= 2015");
		assertNotNull(dataSet);
	...
	public void withWhereTwoConditionsEqualOrNotEqualTestCase() {
		...
		HashMap dataSet = query.executeQuery("select city,winner,team1,team2,player_of_match from data/ipl.csv where season >= 2013 and toss_decision != bat ");
		assertNotNull(dataSet);
	...
	public void withWhereThreeConditionsEqualOrNotEqualTestCase() {
		...
		HashMap dataSet = query.executeQuery("select city,winner,team1,team2,player_of_match from data/ipl.csv where season >= 2008 or toss_decision != bat and city = bangalore");
		assertNotNull(dataSet);
		display("withWhereTwoConditionsEqualOrNotEqualTestCase", dataSet);
